...
const AssignMentorModal: React.FC<AssignMentorModalProps> = ({ isOpen, onClose, student }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log({ studentId: student?.id, newMentor, effectiveDate });
    onClose();
  };
          ...
          <div className="flex flex-col gap-6">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6 flex-1">
              <div className="flex p-6 flex-col gap-4 rounded-[20px] border border-[rgba(0,0,0,0.10)] bg-white">
                ...
                {/* Select New Mentor and Effective Date Row */}
                  ...
                  <div className="flex flex-col gap-1.5 flex-1">
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="Adam Mid">Adam Mid</option>
                        <option value="Dave Alex">Dave Alex</option>
